...
import type { OcpOnPremiseDashboardTab } from './ocpOnPremiseDashboardCommon';
import { selectWidget, selectWidgetQueries } from './ocpOnPremiseDashboardSelectors';
...
export const setWidgetTab = createAction('ocpOnPremiseDashboard/widget/tab')<{
  id: number;
  tab: OcpOnPremiseDashboardTab;
}>();

export const changeWidgetTab = (id: number, tab: OcpOnPremiseDashboardTab): ThunkAction => {
  return dispatch => {
