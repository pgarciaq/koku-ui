      ...
      <Card>
        <CardBody>
          <AsyncComponent
            ...
            migBreakdownPath={formatPath(routePaths.optimizationsGpuMigBreakdown.path)}
            timeslicingBreakdownPath={formatPath(routePaths.optimizationsGpuTimeslicingBreakdown.path)}
            linkState={{
              ...(location?.state || {}),
              efficiencyState: {
