...
export const useVmRecommendationsReport = ({
  ...
  const reportQuery = withRosListProjection({
    ...
    ...(query.filter_by?.is_idle && { is_idle: query.filter_by.is_idle }),
    ...(query.filter_by?.is_abandoned && { is_abandoned: query.filter_by.is_abandoned }),
    ...(query.filter_by?.is_oversized && { is_oversized: query.filter_by.is_oversized }),
    ...(query.filter_by?.is_network_bound && { is_network_bound: query.filter_by.is_network_bound }),
    ...(query.filter_by?.is_power_off_candidate && { is_power_off_candidate: query.filter_by.is_power_off_candidate }),
    ...(query.filter_by?.guest_os && { guest_os: query.filter_by.guest_os }),
    ...tagFilters,
    limit: query.limit,
